...
import { FaBars, FaFacebook, FaInstagram, FaRegEnvelope, FaAngleDown } from 'react-icons/fa'
    ...
    return (
        <div class="container">
            <div class='header'>
                ...
                <nav id="main-menu" class="main-menu">
                    ...
                    <ul class="header-links">
                        ...
                        <Link class="link" to="/about/" href="#" activeClassName="link-active">About Us<FaAngleDown></FaAngleDown></Link>
            ...
            <div class="footer">
                ...
                <div class="copyright"><span>©ExquisiteWater 2020</span></div>
            </div>
        </div>
    )
}
